...
ALTER TABLE E_R ADD CONSTRAINT e_r_p_id_fk FOREIGN KEY (fk_e_p_id) REFERENCES E_P (id);
...
ALTER TABLE RANKING_HORA ADD CONSTRAINT hora_e_r_id_fk FOREIGN KEY (fk_e_r_ranking_id,fk_e_r_ranking_evento_id,fk_e_r_id) REFERENCES E_R (fk_ranking_id,fk_ranking_evento_id,fk_e_p_id);
